            ...
            <section class="services">
                    ...
                    <div class="s-box-container">
                        ...
                        <div class="s-box">
                            ...
                            <div class="bar"></div>
                            <!--img-->
                            <img alt="1" src="Images/transfer2.png" />
                            <!--servies-name-->
                            <br></br><h1>Transfer Money</h1>
                            <!--btn-->
                            <a class="s-btn" href="Users.php">More</a>
                        </div>
                        ...
                        <div class="s-box">
                            ...
                            <div class="bar"></div>
                            <!--img-->
                            <img alt="2" href =" Transaction History.php "src="Images/history.jpg" />
                            <!--servies-name-->
                            <br></br><h1>View Transfer History</h1>  
                            <!--btn-->
                            <a class="s-btn" href="Transaction History.php">More</a>
                        </div>	
                    </div>
            </section>
